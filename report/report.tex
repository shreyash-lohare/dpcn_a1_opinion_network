...
\emph{Measured values are already available} in
\texttt{artifacts/null\_comparison.json}, with the $200$ replicate
distributions cached in \texttt{artifacts/null\_modularity\_replicates.npz}, so
this figure needs plotting rather than recomputing. On the $91$-node respondent
network ($298$ edges, one component) modularity is $0.421$ and clustering
$0.219$; rewiring gives $0.337\pm0.011$ ($z=7.46$) and ER $0.337\pm0.011$
($z=7.28$), both cleared, while the permutation null gives $0.404\pm0.018$
($z=0.91$, $p=0.19$) and is \textbf{not} cleared. These numbers are stated and
interpreted in Section~\ref{sec:nulls-p2}.\\[0.25em]
