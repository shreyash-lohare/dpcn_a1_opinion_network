...
# ---------------------------------------------------------------------------
# Graph building (same logic as person2/graph_7.py and person3/graph_10.py)
# ---------------------------------------------------------------------------
...
def run() -> dict:
    ...
    plot_graph_11(results, operating_threshold,
                  str(FIGDIR_P3 / "graph_11_structural_balance"))
    print(f"\n  wrote {FIGDIR_P3 / 'graph_11_structural_balance'}.png / .pdf")
