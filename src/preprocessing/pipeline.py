...
from src.viz.networks import visualize_network
...
from src.preprocessing.metrics import build_correlation_network, compute_network_statistics, network_edges_frame
from src.preprocessing.reporting import save_markdown_report
from src.preprocessing.similarity import compute_spearman_matrix, row_centre, summarize_correlation_matrix
...
def run_pipeline(config: PipelineConfig = PipelineConfig()) -> Dict[str, object]:
    ...
    # Row-centring: mandatory (see src/preprocessing/similarity.py). Computed here, after
